...
export function EmailVerification({ email, code }: EmailVerificationProps) {
  return (
    <Html lang="en">
      <Head />
      <Preview>Your Vielink verification code: {code}</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Text style={text}>
              Thanks for signing up. Enter the code below to verify <strong>{email}</strong>.
            </Text>
            ...
            <Text style={subText}>
              This code expires in 24 hours. If you did not create a Vielink account, you can ignore this email.
            </Text>
          </Section>
